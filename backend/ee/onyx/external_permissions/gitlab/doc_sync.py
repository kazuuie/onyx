...
from ee.onyx.external_permissions.gitlab.utils import fetch_repository_team_slugs
from ee.onyx.external_permissions.gitlab.utils import form_collaborators_group_id
from ee.onyx.external_permissions.gitlab.utils import form_organization_group_id
...
from ee.onyx.external_permissions.gitlab.utils import get_repository_visibility
from ee.onyx.external_permissions.gitlab.utils import gitlabVisibility
from ee.onyx.external_permissions.perm_sync_types import FetchAllDocumentsFunction
from ee.onyx.external_permissions.perm_sync_types import FetchAllDocumentsIdsFunction
from onyx.access.models import DocExternalAccess
from onyx.access.utils import build_ext_group_name_for_onyx
from onyx.configs.constants import DocumentSource
from onyx.connectors.gitlab.connector import DocMetadata
...
def _check_repository_for_changes(
    ...
    if get_repository_visibility(
        repo
    ) == gitlabVisibility.PRIVATE and _teams_updated_from_groups(
        repo=repo,
